...
import { CheckCircle, Users, Brain, BarChart3, Shield, Calendar, ArrowRight, Star, Zap, Target, Code, Bot } from 'lucide-react';
...
export default function Landing() {
  ...
  const features = [
    {
      ...
      description: "Automatically classify tasks as Bug, Feature, or Extension using advanced NLP",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: <BarChart3 className="w-8 h-8" />,
      title: "Developer Performance Ratings",
      description: "AI-powered performance scoring based on completion time, accuracy, and quality",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Role-Based Access Control",
      description: "Secure task management with Admin, Manager, and Developer permissions",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Interactive Kanban Interface",
      description: "Smooth drag-and-drop functionality for real-time task management",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <nav className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#technology" className="hover:text-purple-300 transition-colors">Technology</a>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Revolutionize your project management with AI-powered task categorization, 
              performance analytics, and intelligent workflow optimization.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
            ...
            {features.map((feature, index) => (
              <div
                ...
                className={`p-6 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 hover:border-purple-500/50 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl ${
                  currentFeature === index ? 'ring-2 ring-purple-500/50 scale-105' : ''
                }`}
              >
      ...
      {/* Technology Stack */}
      <section id="technology" className="relative z-10 px-6 py-20 bg-slate-800/20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {technologies.map((tech, index) => (
              ...
              >
                <div className="text-sm text-cyan-300 mb-1">{tech.category}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 hover:border-orange-400/50 transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-orange-300">Project Mode</h3>
              </div>
              <p className="text-slate-300 leading-relaxed">
                Long-term project tracking with comprehensive task records, progress monitoring, 
                and resource allocation insights for managers and stakeholders.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:border-green-400/50 transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-green-300">Sprint Mode</h3>
              </div>
              <p className="text-slate-300 leading-relaxed">
                Sprint-focused task management with automatic task carryover, 
                ensuring continuous progress tracking and agile workflow optimization.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="p-6 rounded-xl bg-slate-800/30 border border-slate-700/30 hover:border-purple-500/50 transition-all duration-300">
      ...
      <footer className="relative z-10 px-6 py-8 border-t border-slate-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-slate-400">
            © 2024 TaskPilot - Bachelor of Engineering Project in Computer Science and Engineering
          </p>
